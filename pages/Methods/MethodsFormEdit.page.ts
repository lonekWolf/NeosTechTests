...
export class MethodsFormEditPage {
    ...
    parametrRecalculate = this.page.locator(`//*[contains(@class,'Field__recalculate')]//input`);
    ...
    fFloat = this.page.locator(`//*[contains(@class,'Field_FFLOAT')]//input`).first();
    fSmallInt = this.page.locator(`//*[contains(@class,'Field_FSMALLINT')]//*[contains(@class,'k-input')]`);
    parameterEdit = this.page.locator(`//*[contains(@class,'Field__p1')]//input`).first();
    ...
    async RecalculationParams(recalParametrValue: string): Promise<void> {
        await this.parametrRecalculate.fill(recalParametrValue);
