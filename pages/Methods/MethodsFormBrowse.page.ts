...
export class MethodsFormBrowsePage {
    readonly parameterRecalculation: Locator;
    ...
    constructor(private page: Page) {
        this.parameterRecalculation = this.page.locator(`//*[contains(@class,'Field__recalculate')]//input`);
        ...
        this.parameterEdit = this.page.locator(`//*[contains(@class,'Field__p1')]//input`);
        ...
        this.fFloat = this.page.locator(`//*[contains(@class,'Field_FFLOAT')]//input`);
    ...
    async RecalculationParams(recalcParameterValue: string): Promise<void> {
        await this.parameterRecalculation.fill(recalcParameterValue);
